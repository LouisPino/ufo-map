...
for i in range(3):
    html = requests.get(url + str(i + 179116))
    ...
    new_dict = {
        ...
        # "location_details": new_entry.split("details:</b> ")[1].split("<br/>")[0], Need to check whether or not details exist first
        "shape": new_entry.split("<b>Shape:</b> ")[1].split("<br/>")[0],
        "duration": new_entry.split("<b>Duration:</b> ")[1].split("<br/>")[0],
        "observers": new_entry.split("<b>No of observers:</b> ")[1].split("<br/>")[0],
        "reported": new_entry.split("<b>Reported:</b> ")[1].split("<br/>")[0],
        "posted": new_entry.split("<b>Posted:</b> ")[1].split("<br/>")[0],
        "characteristics": new_entry.split("<b>Characteristics:</b> ")[1].split("<p style=\"color: white;")[0].replace("<br/>", "").replace("<br>", "")     
        }
